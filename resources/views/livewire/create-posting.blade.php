<div>
    ...
    <div class="bg-[#151922] w-[calc(100%-300px)] h-screen absolute">
        <div class="m-4 p-4 bg-white rounded flex h-[calc(100%-2rem)] relative">
            <div class="flex flex-col flex-1">
                <h1 class="text-2xl font-bold mb-4">Job <span class="text-green-400">Posting</span></h1>
                ...
                <label class="font-bold" for="deadline">Budget (PHP)</label>
            ...
            <div class="flex flex-col flex-1 p-4 mt-14">
                <div id="drop-zone" class="mb-3 flex flex-col items-center w-full h-40 p-6 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:border-gray-400 transition">
                    ...
                    <label for="file-input">
                        <span class="text-sm text-gray-600">Drop files here or <span class="text-blue-600 underline">browse</span></span>
                    </label>
            ...
            <div class="absolute right-0 bottom-0 m-5 flex">
                <a class="font-semibold px-3 py-1" href="/client/dashboard" wire:navigate>Discard</a>
                <div class="mx-2"></div>
