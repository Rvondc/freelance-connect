        ...
        <form action="#">
            <div class="px-3 pb-3 pt-1.5 my-2 rounded-lg bg-slate-800 shadow-lg shadow-black/30">
                ...
                <div class="flex gap-3 max-sm:flex-col">
                    <div
                        class="flex items-center justify-between p-3 font-semibold bg-green-400 rounded-lg flex-nowrap md:basis-1/2 lg:basis-1/3">
                    ...
                    <div
                        class="flex items-center justify-between p-3 font-semibold bg-gray-300 rounded-lg flex-nowrap md:basis-1/2 lg:basis-1/3">
                        <label for="client">
                            <h3>Client</h3>
                ...
                <div class="flex flex-col gap-2 md:flex-row md:gap-3">
                    ...
                    <div class="flex flex-col md:basis-1/3">
                        ...
                        <input type="text" name="middle_name" id="middle_name"
                            class="h-10 px-3 rounded-lg md:w-full">
                    </div>
                    <div class="flex flex-col md:basis-1/3">
