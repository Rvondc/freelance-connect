            ...
            <form action="#" class="bg-red-300 size-3/5">
                <div class="p-3 mx-5 my-2 rounded bg-slate-800">
                    ...
                    <div class="flex gap-3">
                        <div class="flex items-center justify-between p-3 font-semibold bg-green-400 rounded flex-nowrap basis-1/4">
                        ...
                        <div class="flex items-center justify-between p-3 font-semibold bg-gray-300 rounded flex-nowrap basis-1/4">
                            <label for="client">
                                <h3>Cient</h3>
